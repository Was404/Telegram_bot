...
async def start_handler(message: Message):
    ...
    await message.reply(f"Здравствуйте, {user_fullname}.\nВоспользуйтесь командой /items")
...
async def cancel_buying(call: CallbackQuery):
    ...
    await call.message.answer(text="На продажу у нас есть 2 товара: 5 Яблок и 1 Груша. \n"
                              "Если вам ничего не нужно - жмите отмену",
                         reply_markup=choice)
